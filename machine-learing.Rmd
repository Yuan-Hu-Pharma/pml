...
training  <-taa[inTrain,]
validating<-taa[-inTrain,]
```
...
From the confusion matrix we can find the accuracy of the model is as high as 1. 
The out of sample error is calculated as `1 - accuracy` for predictions made against the cross-validation set. The out of sample error is almost 0. 
